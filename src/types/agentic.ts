...
export type ModelProviderStatus = { kind: ModelProviderKind; baseUrl: string; model: string; maxContextTokens: number; apiKeyConfigured: boolean; apiKeyStored: boolean };
