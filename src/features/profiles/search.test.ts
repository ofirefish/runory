...
const profiles: ServerProfile[] = [
  { id: "profile-1", name: "API", host: "10.0.0.1", port: 22, username: "root", groupId: group.id, authMethod: "password", connectionRoute: { type: "direct" }, sortOrder: 0, createdAt: "1", updatedAt: "1" },
  { id: "profile-2", name: "Staging", host: "staging.example.com", port: 22, username: "deploy", groupId: null, authMethod: "password", connectionRoute: { type: "direct" }, sortOrder: 1, createdAt: "1", updatedAt: "1" },
];
