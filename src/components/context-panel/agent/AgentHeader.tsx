 ...
 */
export function AgentHeader({ profile, connected, state, runState, running, onNewConversation, onOpenHistory, onPause, onResume, historyOpen = false }: {
  ...
  return <header className="agent-header">
    ...
    <div className="agent-header-actions">
      ...
      <button type="button" className="agent-icon-button" data-agent-history-trigger aria-haspopup="dialog" aria-expanded={historyOpen} aria-label={t("contextPanel.history")} title={t("contextPanel.history")} onClick={onOpenHistory}><History size={15} /></button>
